...
Flat.create!(
  name: 'Beautiful Villa overlooking the Thames River',
  address: '6 Hinton Rd BH1 2EN',
  description: 'A villa fit for a family, it has all the amenities you need and is very comforting. Pets are allowed. And you will have the villa all to yourself.',
  price_per_night: 140,
  number_of_guests: 4
)
